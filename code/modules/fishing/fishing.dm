...
GLOBAL_LIST_INIT(generic_fishing_rare_list, list(
		/mob/living/simple_animal/fish/solarfish = 1,
		/mob/living/simple_animal/fish/icebass = 5,
...
GLOBAL_LIST_INIT(generic_fishing_uncommon_list, list(
		...
		/mob/living/simple_animal/fish/javelin = 3,
		/mob/living/simple_animal/crab/sif = 1
		))
...
GLOBAL_LIST_INIT(generic_fishing_common_list, list(
		...
		/mob/living/simple_animal/fish/murkin = 8,
		/mob/living/simple_animal/fish/rockfish = 5,
